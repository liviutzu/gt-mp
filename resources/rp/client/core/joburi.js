...
API.onUpdate.connect(function () {
    if (Camionagiu_InCursa == true)
    {
        if (Camionagiu_IesitDinCamion == false)
        {
            ...
            {
                API.displaySubtitle("Ataseaza remorca!", 5);
            }
            else
            {
        ...
        {
            API.displaySubtitle("Intra inapoi in camion!", 5);
        }
    }
});
    ...
    if (eventName == "job_trucker") {
        ...
        if (args[1] == 1) {
            ...
            primacursa.Activated.connect(function (job_trucker, item) {
                ...
                API.triggerServerEvent("job_trucker_cursa", 200, 0, 3, "Docuri", "La Mesa", "Container", 1);
            ...
            adouacursa.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 400, 1, 12, "Docuri", "Davis", "Alimente", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 5);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            atreia.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 700, 2, 12, "Docuri", "Hookies", "Peste congelat", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            apatra.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1000, 3, 11, "Docuri", "Paleto Forest", "Busteni", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            acincea.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1200, 4, 13, "Docuri", "Paleto Bay", "Instrumente Macelarie", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            asasea.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1000, 5, 7, "Docuri", "Grapeseed", "Platforma", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            asaptea.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1100, 6, 9, "Docuri", "San Chainski", "Cisterna", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            aopta.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 900, 7, 4, "Docuri", "Grand Senora", "Trailer", 1);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
        ...
        } if (args[1] == 2)
        {
            ...
            let primacursa = API.createColoredItem("Alimente - Chiliad Mountain State - ~g~200$", "Livreaza aliemnte la Chiliad Mountain State si vei primi 200$ la finalul cursei.", "#2a770e", "#53d125");
            let adouacursa = API.createColoredItem("Piese de schimb - Paleto Forest - ~g~220$", "Livreaza piese de schimb la Paleto Forest si vei primi 220$ la finalul cursei.", "#2a770e", "#53d125");
            let atreia = API.createColoredItem("Bere - North Chumash - ~g~400$", "Livreaza bere la North Chumash si vei primi 400$ la finalul cursei.", "#2a770e", "#53d125");
            let apatra = API.createColoredItem("Combustibili - Lago Zancudo - ~g~700$", "Livreaza combustibili la Lago Zancudo si vei primi 700$ la finalul cursei.", "#2a770e", "#53d125");
            let acincea = API.createColoredItem("Masini de lux - Rockford Hills - ~g~1000$", "Livreaza masini la Rockford Hills si vei primi 1000$ la finalul cursei.", "#2a770e", "#53d125");
            let asasea = API.createColoredItem("Platforma - Rockford Hills - ~g~1200$", "Livreaza platforma la Rockford Hills si vei primi 1200$ la finalul cursei.", "#2a770e", "#53d125");
            let asaptea = API.createColoredItem("Medicamente - Rockford Hills - ~g~1500$", "Livreaza medicamente la Rockford Hills si vei primi 1500$ la finalul cursei.", "#2a770e", "#53d125");
            ...
            primacursa.Activated.connect(function (job_trucker, item) {
                ...
                API.triggerServerEvent("job_trucker_cursa", 200, 8, 14, "Mount Chiliad", "Chiliad Mountain State", "Alimente", 2);
                Camionagiu_InCursa = true;
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 5);
                job_trucker.Visible = false;
            });
            adouacursa.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 220, 9, 3, "Mount Chiliad", "Paleto Forest", "Piese de schimb", 2);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 5);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            atreia.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 400, 10, 13, "Mount Chiliad", "North Chumash", "Bere", 2);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            apatra.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 700, 11, 9, "Mount Chiliad", "Lago Zancudo", "Combustibili", 2);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            acincea.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1000, 12, 6, "Mount Chiliad", "Rockford Hills", "Masini de lux", 2);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            asasea.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1200, 13, 7, "Mount Chiliad", "Rockford Hills", "Platforma", 2);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
            asaptea.Activated.connect(function (job_trucker, item) {
                API.triggerServerEvent("job_trucker_cursa", 1500, 14, 12, "Mount Chiliad", "Rockford Hills", "Medicamente", 2);
                API.displaySubtitle("Livreaza remorca pentru a primi recompensa.", 15);
                Camionagiu_InCursa = true;
                job_trucker.Visible = false;
            });
