...
API.onServerEventTrigger.connect(function (eventName, args) {
    ...
    if (eventName == "Register_TotulInRegula")
    {
        menu.Visible = false;
    }
    if (eventName == "Register_NumeInvalid") {
        API.setMenuTitle(menu, "Nume invalid!");
        nume = null;
        menu.Visible = true;
    }
    if (eventName == "Register_PrenumeInvalid") {
        API.setMenuTitle(menu, "Prenume invalid!");
        prenume = null;
        menu.Visible = true;
    }
    if (eventName == "Register_TaraInvalid") {
        API.setMenuTitle(menu, "Tara invalida!");
        tara = null;
        menu.Visible = true;
    }
    if (eventName == "Register_AniInvalizi")
    {
        API.setMenuTitle(menu, "Ani invalizi!");
        varsta = null;
        menu.Visible = true;
    }
    if (eventName == "CreateMenu") {
        menu = API.createMenu("Caracter", "Informatii despre tine", 0, 0, 6);
         numeitem = API.createColoredItem("Nume", "Numele dvs.", "#771616", "#d11919");
         prenumeitem = API.createColoredItem("Prenume", "Prenumele dvs.", "#771616", "#d11919");
         varstaitem = API.createColoredItem("Varsta", "Varsta dvs.", "#771616", "#d11919");
         taraitem = API.createColoredItem("Tara", "Tara de origine.", "#771616", "#d11919");
        ...
        function activated() {
            if (nume != null && prenume != null && varsta != null && tara != null) {
                ...
                nextitem.Activated.connect(function (menu, item) {
                    if (nume != null && prenume != null && varsta != null && taraitem != null) {
