...
API.onServerEventTrigger.connect(function (eventName, args) {
    ...
    if (eventName == "SendToWorld")
    {
        API.triggerServerEvent("SendToWorld");
    }
    ...
    if (eventName == "loginCallBack") {
        ...
        LoginForm = API.createCefBrowser(resolution.Width, resolution.Height, true);
        API.waitUntilCefBrowserInit(LoginForm);
        API.setCefBrowserPosition(LoginForm, 0, 0);
        API.setCefBrowserHeadless(LoginForm, false);
